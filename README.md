...
Na tej strani boste našli navodila za pripravo delovnega okolja za predmet Geoinformatika III, ki se izvaja na Fakulteti za gradbeništvo in geodezijo Univerza v Ljubljani. Vsebina vključuje namestitev potrebnih programov, nastavitev Conda/Mamba okolja, uporabo GitHub-a in Visual Studio Code-a ter kloniranje repozitorija z gradivi za predmet.

![GeoPython](figures/geopython_256.png)

## Uvod

Za delo pri predmetu Geoinformatika III bomo uporabljali Python in Jupyter Lab. Večino dela bomo opravili v razvojnem okolju Visual Studio Code. Če že uporabljate Visual Studio Code, ga posodobite na najnovejšo različico. Če ga še nimate, ga namestite z [https://code.visualstudio.com/](https://code.visualstudio.com/). Lahko pa uprabite tudi PyCharm ali katero koli drugo IDE, ki podpira Python in Jupyter Notebooke.

Za delo z različicami bomo uporabljali Git, zato je tudi namestitev Gita del teh navodil. Vse skupaj bomo povezali z delo z GitHubom, zato si pridobite GitHub račun, če ga še nimate. To lahko storite na strani [Build software better, together](https://github.com/signup).
...
Če naletite na težave, posodobite knjižnice v okolju `geoinfo` z naslednjim ukazom, vendar boste s tem dobili okolje, ki ni več enako kot v `environment.yml`. Če želite ohraniti okolje usklajeno z `environment.yml`, uporabite ukaz za posodobitev okolja:
...
Nastavite svoje uporabniško ime in e-poštni naslov, ki bsta uporabljena za vaše Git commite:
...
![Posnetek zaslona VSCode](figures/VSCode.png)
...
![Prijava v VSCode in sinhronizacija](figures/VSCode_sync.png)
...
![Namestitev razsiritve v VSCode](figures/VSCode_plugins.png)
...
![Izbira kernel v VSCode](figures/VSCode_kernel.png)

Izberite okolje `geoinfo`.

![Izbira okolja geoinfo v VSCode](figures/VSCode_environment.png)
...
![Zagon okolja geoinfo v VSCode](figures/VSCode_geoinfo.png)
...
![Kloniranje repozitorija v VSCode](figures/VSCode_gitclone.png)

Izberite GitHUb kot vir repozitorija.

![Izbira vira GitHub v VSCode](figures/VSCode_gitclone_github.png)

Nato vnesite URL repozit☻orija `https://github.com/UL-FGG/geo3-2526.git`.

![Vnos URL repozitorija v VSCode](figures/VSCode_gitclone_repo.png)
...
* Python (Anaconda ali Miniforge)
* Ustvarjeno Conda/Mamba okolje geoinfo z vsemi potrebnimi knjižnicami
* Git
* GitHub račun
* Visual Studio Code z nameščenimi razširitvami
